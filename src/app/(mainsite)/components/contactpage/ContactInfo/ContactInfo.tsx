...
export default function ContactInfo() {
  return (
    <section className={styles.contactInfo}>
      <h2>We’d Love to hear your questions and feedback!</h2>
        <div className={styles.stuffWrapper}>
        <div className={styles.textContent}>
          <p>We can’t wait to get your child the experience they need!</p>
        ...
        <div style={{backgroundColor: "rgba(0, 106, 53, .80)"}} className="shader"></div>
